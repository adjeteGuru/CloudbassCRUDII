...
namespace CloudbassCRUDII.Controllers
{
    public class JobDController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,text,Description,Location,DateCreated,start_date,TXDate,end_date,Coordinator,CommercialLead,ClientId")] Job job)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,text,Description,Location,DateCreated,start_date,TXDate,end_date,Coordinator,CommercialLead,ClientId")] Job job)
        {
            if (ModelState.IsValid)
            {
