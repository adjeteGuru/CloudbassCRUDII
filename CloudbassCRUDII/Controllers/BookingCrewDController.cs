...
namespace CloudbassCRUDII.Controllers
{
    public class BookingCrewDController : Controller
    {
        ...
        {
            var bookingCrews = db.BookingCrews.Include(b => b.Employee).Include(b => b.Has_Role).Include(b => b.Schedule);
        ...
        public ActionResult Create([Bind(Include = "scheduleId,has_RoleId,start_date,end_date,totalDays,rate,createdBy")] BookingCrew bookingCrew)
        {
            ...
            ViewBag.createdBy = new SelectList(db.Employees, "Id", "fullName", bookingCrew.createdBy);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "scheduleId,has_RoleId,start_date,end_date,totalDays,rate,createdBy")] BookingCrew bookingCrew)
        {
            if (ModelState.IsValid)
            {
